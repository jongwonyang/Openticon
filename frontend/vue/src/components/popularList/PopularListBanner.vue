<template>
    <div class="w-full h-28 bg-[#98cbff] overflow-hidden" style="user-select: none;">
        <div class="relative mx-auto max-w-screen-lg h-full">
            ...
            <p class="absolute top-[19%] left-[53%] text-3xl font-nnsqneo-heavy text-sky-600 z-0 blur-[3.1px] whitespace-nowrap">많이쓰는</p>
            <p class="absolute top-[28%] left-[67%] text-3xl font-nnsqneo-heavy text-blue-600 z-0 blur-[2.1px] whitespace-nowrap">익숙한</p>
