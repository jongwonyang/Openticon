...
public class ImageHashController {
    ...
    public ResponseEntity<List<ImageHashResponseDto>> searchEmoticonPackByImage(@RequestPart MultipartFile image) throws IOException {

        return ResponseEntity.status(HttpStatus.OK).body(imageHashService.searchImage(image));
    }
}
