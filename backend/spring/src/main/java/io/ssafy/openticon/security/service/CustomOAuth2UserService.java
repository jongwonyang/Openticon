...
import io.ssafy.openticon.security.member.OAuth2MemberInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest userRequest, OAuth2User oAuth2User) {
        ...
        OAuth2MemberInfo oAuth2UserInfo = OAuth2MemberInfoFactory.getOAuth2UserInfo(registrationId,
                accessToken,
