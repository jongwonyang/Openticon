...
//        configuration.setAllowedOrigins(List.of("*")); // Allow all origins, or specify specific origins
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000", "http://127.0.0.1:3000", "http://127.0.0.1:5173", "http://localhost:5173", "http://127.0.0.1:8080"));
